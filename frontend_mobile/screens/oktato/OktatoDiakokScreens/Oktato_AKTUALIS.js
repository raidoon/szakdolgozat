...
export default function Oktato_AKTUALIS({ route }) {
    ...
    const renderEmptyComponent = () => (
        <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyTitle}>Nincsenek aktuális diákok</Text>
            <Text style={styles.emptyText}>Jelenleg nincsenek hozzárendelt diákjai</Text>
            <TouchableOpacity 
                style={styles.refreshButton}
                onPress={letoltes}
            >
                <MaterialIcons name="refresh" size={20} color="#00796B" />
