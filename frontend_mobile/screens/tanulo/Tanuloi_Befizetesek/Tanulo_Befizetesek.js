    ...
    return (
      ...
      >
        ...
        <Text style={styles.betoltesText}>
          A fizetési előzmények betöltése folyamatban van. Kérjük, legyen
          türelemmel...
        </Text>
      </View>
    );
      ...
      {befizetLista.length === 0 ? (
        ...
        >
          ...
          <Text style={styles.nincsOra}>
            Itt megnézheted az összes korábbi és aktuális tranzakciót, és azok
            részleteit.
          </Text>
          <Text style={styles.vanOra}>
            Például: mikor történt a befizetés, el lett-e fogadva, és ha igen,
            akkor ki hagyta jóvá.
          </Text>
        </View>
      ) : (
