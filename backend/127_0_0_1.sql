...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Dec 12. 08:58
...
--
CREATE DATABASE IF NOT EXISTS `szakdoga_gyakorlas` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci;
USE `szakdoga_gyakorlas`;
...
INSERT INTO `felhasznaloi_adatok` (`felhasznalo_id`, `felhasznalo_nev`, `felhasznalo_email`, `felhasznalo_jelszo`, `felhasznalo_telefonszam`, `felhasznalo_tipus`, `felhasznalo_autosiskola`) VALUES
(1, 'raidonss', 'raidonss@gmail.com', 'qwertzui123', '56556656', 0, 1),
(2, 'illjanos', 'illjanos@gmail.com', 'illjanos123', '5645465', 1, 1);
