        ...
        return (
          <View
            ...
            style={{
              ...
              elevation: 5,
              borderLeftWidth: 6,
              borderLeftColor: item.ora_tipusID === 1 ? "#6A5AE0" : "#FF6B6B", // Different color for exam
            }}
          >
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              <Ionicons
                name={item.ora_tipusID === 1 ? "car-sport-outline" : "school-outline"} // Different icon for exam
                size={24}
                color={item.ora_tipusID === 1 ? "#6A5AE0" : "#FF6B6B"}
